            ...
            <div className='container-fluid w-full px-0 lg:px-3 grid grid-cols-1 md:grid-cols-2 items-center  justify-between' >
                <div>
                    ...
                    <div className='flex gap-2 justify-start items-center mt-4'>
                        ...
                        <a target='blank' href='https://drive.google.com/file/d/1meyVo1FnLephifEzfShBakmv750TM6pM/view?usp=sharing' className=' hover:bg-primary transition text-black hover:text-white   bg-secondary px-4 py-2 rounded '>Download  CV</a>
                    </div>
                </div>
