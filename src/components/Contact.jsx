        ...
        <section className='py-8' id='Contact'>
            <div className=' container py-5'>
                ...
                <form onSubmit={handleSubmit} className=' pt-10   md:w-1/2 mx-auto '>
                    ...
                    <button className=' w-full bg-primary py-2 rounded-[8px] text-white hover:bg-primary/50 hover:-skew-x-6 hover:sdcale-110  transition ' type='submit'>Submit</button>
